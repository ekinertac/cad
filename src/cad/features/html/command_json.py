"""
features/html/command_json.py — the ``cad json`` click subcommand.

Convert one local JSONL/JSON file (or URL) to a paginated HTML
transcript. The first historical entry point to the renderer — and
still the most useful for one-off shares.
"""
