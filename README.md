...
- `cad live` — flat dashboard of running agent sessions grouped by project (`[working]` / `[input]` / `[idle]`). One-shot snapshot; pair with `watch -n 5 cad live` for a live view in another terminal.
